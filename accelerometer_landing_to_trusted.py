...
DropFields_node1763644123709 = DropFields.apply(frame=Join_node1763643636093, paths=["birthDay", "shareWithPublicAsOfDate", "shareWithResearchAsOfDate", "registrationDate", "customerName", "shareWithFriendsAsOfDate", "email", "lastUpdateDate", "phone", "serialNumber"], transformation_ctx="DropFields_node1763644123709")
...
AccelerometerTrusted_node1763644235527 = glueContext.getSink(path="s3://stedi-lake-house/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AccelerometerTrusted_node1763644235527")
AccelerometerTrusted_node1763644235527.setCatalogInfo(catalogDatabase="stedi",catalogTableName="accelerometer_trusted")
AccelerometerTrusted_node1763644235527.setFormat("json")
AccelerometerTrusted_node1763644235527.writeFrame(DropFields_node1763644123709)
job.commit()
